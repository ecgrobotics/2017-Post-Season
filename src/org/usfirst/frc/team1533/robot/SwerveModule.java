...
public class SwerveModule {
    ...
    public SwerveModule(SpeedController driveController, SpeedController steerController, 
    	...
    	steerPID = new PIDController(Constants.Steering.SWERVE_STEER_P, Constants.Steering.SWERVE_STEER_I, Constants.Steering.SWERVE_STEER_D,
    			steerEncoder, steerController);
    	steerPID.setInputRange(0, 2*Math.PI);
    	steerPID.setOutputRange(-Constants.Steering.SWERVE_STEER_CAP, Constants.Steering.SWERVE_STEER_CAP);
