...
public class Swerve extends Subsystem {
	...
	public Swerve(Joystick joy1, Gyro gyro) {
		...
		modules = new SwerveModule[] {
				//front left
				new SwerveModule(new Talon(Constants.FL_DRIVE),
				...
				//back left
				new SwerveModule(new Talon(Constants.BL_DRIVE),
	...
	public void move(){
		if(joy1.getRawButton(Constants.RIGHT_TRIGGER)){	
		...
		if(joy1.getRawButton(Constants.LEFT_TRIGGER)){
			gyro.reset();
		}
